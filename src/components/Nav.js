...
reliability and reducing reported bugs by 20%.</p>
    ...
    <div className="w-1/5 pr-5"> <img src="/arbnb.jpg" alt="Airbnb clone" className="icon" /></div>
    <div className="w-4/5 text-xs">
    <h3 className="job-title">Airbnb Clone App (React)</h3>
    <p className="pt-3">A responsive Airbnb clone built with React, allowing users 
to search, filter, and view listings. The app features a 
dynamic UI for smooth navigation and interaction. Built using 
React for efficient content rendering and state management.</p>
    <div className="skills-container text-xs pt-2">
<span className="skill-badge ">React</span>
...
<div className="flex font-body pt-4 job-container">
<div className="w-1/5 pr-5"> <img src="/digital.jpg" alt="Airbnb clone" className="icon" /></div>
    <div className="w-4/5 text-xs">
    <h3 className="job-title">Digital Business Card App</h3>
    <p className="pt-3">Created a responsive digital business card app using React, 
allowing users to customize and share their cards seamlessly. 
Integrated real-time updates and easy sharing via QR code or 
link.</p>
    <div className="skills-container text-xs pt-2">
<span className="skill-badge ">React</span>
...
<div className="flex font-body pt-4 job-container">
<div className="w-1/5 pr-5"> <img src="/travel.jpg" alt="Airbnb clone" className="icon" /></div>
    <div className="w-4/5 text-xs">
    <h3 className="job-title">Travel experience app</h3>
    <p className="pt-3">A travel experience app built with React that showcases six 
popular cities, displaying notable locations within each 
city along with their ratings and user impressions. The app 
offers an interactive interface to explore top travel 
destinations.</p>
    <div className="skills-container text-xs pt-2">
    <span className="skill-badge ">React</span>
<span className="skill-badge">HTML</span>
